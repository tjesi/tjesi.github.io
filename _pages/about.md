...
- Kristian Gjøsteen (NTNU), Jonathan Komada Eriksen (KU Leuven), Øyvind Ytrehus and Morten Øygarden (both UiB), and myself published an opintion piece about [PQC vs. QKD](https://www.digi.no/artikler/debatt-spekulativ-kvanteteknologi-loser-ikke-sikkerhetsproblemene-vare/568500) in digi.no today, arguing that post-quantum crypto is the right path forward.
